...
const Home = () => {
  return (
    <>
      {/* // Hero section */}
      <section
        className="hero__section pt-[60px] 2xl:h-[800px]
        mb-20"
      >
            ...
            <div>
              ...
              >
                ...
                <div>
                  ...
                  <span
                    className="w-[100px] h-2 bg-purpleColor rounded-full
                      block mt-[-14px]"
                  ></span>
        ...
        <div className="container">
          ...
          >
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                <h2
                  className="text-[26px] leading-9 text-headingColor
                  font-[700] text-center"
                >
                  Find a Doctor
                </h2>
                <p
                  className="text-[16px] leading-7 text-textColor
          ...
          >
            ...
            <div className="xl:w-[670]">
              ...
              <ul className="pl-4">
                ...
                <li className="text__para">2.Know your healty standarts</li>
                <li className="text__para">
            ...
            >
              ...
              >
                ...
                <div
                  className="w-[65px] lg:w-[96px] bg-[#ccf0f3] py-1
